...
class _ChatRoomState extends State<ChatRoom> {
  ...
  String receiverDisplayPic =
      'https://e7.pngegg.com/pngimages/150/864/png-clipart-anonymous-icon-business-user-s-purple-stockxchng-thumbnail.png';
              ...
              showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      ...
                      content: Text('Deseja excluir esta mensagem?'),
                      actions: <Widget>[
                        TextButton(
                          child: Text(
                            'Não',
